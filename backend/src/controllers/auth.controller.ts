...
export async function register(req: Request, res: Response): Promise<void> {
  try {
    // move logic to the service and just catch the errors here and send the status + errors here
...
export async function verifyEmail(req: Request, res: Response): Promise<void> {
  try {
    ...
    const token =
      (req.body as VerifyEmailInput).token || (req.query.token as string);
